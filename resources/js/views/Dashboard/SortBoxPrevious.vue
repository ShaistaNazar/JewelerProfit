        ...
        <custom-alert v-if="showDismissibleAlert" :showDismissibleAlert="showDismissibleAlert" :msg="alertMsg" :variant="variant"/>
             <div class="container">
                ...
                <div class="col-lg-4 col-md-4 p-0 mb-0 align-items-center">
                    <div class="form-group has-search fa_search col-lg-12 col-md-12 mb-0 justify-content-center">
                        <input
                        type="text"
                ...
                <div class="jobsListing_section my_jobListing">
                    <ul>
                        ...
                        :key="envelope_index" >
                                ...
                                <div class="jobsListing_info">
                                    <div class="row flex-nowrap align-items-center">
                                       ...
                                       <div class="">
                                        ...
                                        <div class="">
                                            <div class="jobsListing_col">
                                                {{new Date(envelope.take_in_date).toLocaleString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}}
                                            </div>
                                        </div>
                            ...
                            <div class="location_bg mt-2 mb-4"  v-if="seen == envelope.envelope_id">
                                        ...
                                        <table class="table"> 
                                            <tbody>
                                                 ...
                                                 <tr v-for="(price_details,price_details_index) in envelope.sort_box_job_history.price_chart" :key="price_details_index">
                                                    ...
                                                    <td width="250" class="text-success">
                                                        <strong>
                                                            {{price_details_index}}
                                                        </strong>
                                                    </td>
    ...
    export default {
        ...
        watch: {
            selected_location(newVal, oldVal) {
                if(newVal == 'finished_box')
                {
                    this.showFinished_date = true
                }
                if(newVal !== 'jeweler_box')
                {
                    this.selected_jeweler = null
                }
            },
      ...
      selectVendor(vendor)
      {
        this.selected_vendor = vendor.value;
        // this['dataStore/bindSalePerson'](vendor.value);
      },
      getSortBox(page = 1) 
      {
        this.setLoader(true);
        var token = localStorage.getItem("token");
        axios
            .get(`/api/get-sort-box?filter=${this.searchQuery}&page=` + page, {
            headers: {
                Authorization: "Bearer " + token,
            },
            })
