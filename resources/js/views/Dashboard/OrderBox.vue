<template>
                ...
                <div class="row pb-4  align-items-center">  
                    <div class="col-lg-4 col-md-8">
                        <div class="shank_tittle">
                            ...
                            <h5 class="m-0 p-0 ml-3">Order Box</h5>
                        </div>
                    </div>
                    
                <div class="col-lg-4 col-md-4 p-0 mb-0 align-items-center">
                    <div class="form-group has-search fa_search mb-0 col-lg-12 col-md-12 justify-content-center">
                        <input
                        type="text"
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="mySelect_outer d-flex justify-content-end align-items-center">
                            <b-button class="btn-success" :disabled="ifnoneSelected" v-b-modal.location-modal>Move to Locations</b-button>
                        </div>
                    </div>
                                ...
                                <li>
                                    <div class="location_bg">
                                        <div class="jobsListing_info">
                                            <div class="row flex-nowrap align-items-center text-warning">
                                                ...
                                                <div>
                                                    <div class="jobsListing_col">
                                                        <strong>When placed order</strong>
                                                    </div>
                                                </div>
    ...
    <!-- {{resultQuery}} -->
                        <div class="jobsListing_section">
                        <ul >
                            <li  v-for="(envelope,envelope_index) in resultQuery.data"
                            :key="envelope_index" >
                                <!-- <div> -->
                                        ...
                                        <div class="row flex-nowrap align-items-center">
                                            <div>
                                                <label class="custom_checkbox">
                                                    <input type="checkbox" v-model="envelope.checked" :id="'checkbox-' + envelope_index">
                                            ...
                                            <div>
                                                <div class="jobsListing_col">
                                                    {{new Date(envelope.placed_order_date).toLocaleString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}}
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="jobsListing_col">
                                                    {{new Date(envelope.arrival_date).toLocaleString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}}
                                                </div>
                                            </div>

                                            <div>
                                                <div class="jobsListing_col" v-if="envelope.vendor_id && envelope.vendor && envelope.vendor.link">
                                                    {{envelope.vendor.link}}
                                                    <!-- <strong>{{envelope.arrival_date}}</strong> -->
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                <div class="jobsListing_col">
                                                    <strong>{{envelope.total_with_sales_tax}}</strong>
                                                </div>
                                            </div>

                                            <div>
                                                <div class="jobsListing_col">
                                                    <strong v-if="envelope.sale_person">{{envelope.sale_person.fullname}}</strong>
                                                </div>
                                            </div>
                                        
                                            <div>
                                                <div class="sortBttn">
                                                    <button class="btn btn-success" v-if="seen !== envelope.envelope_id" v-on:click="seen = envelope.envelope_id">Show Details</button>
                                                    <button class="btn btn-success" v-if="seen == envelope.envelope_id" v-on:click="seen= ''">Hide Details</button>
                                                </div>
                                            </div>
                                ...
                                <div class="location_bg mt-4"  v-if="seen == envelope.envelope_id">
                                        ...
                                        <div class="jobDetail_info">
                                            <table class="table"> 
                                                <tbody>
                                                    ...
                                                    <tr v-for="(price_details,price_details_index) in envelope.sort_box_job_history.price_chart" :key="price_details_index">
                                                        ...
                                                        <td width="350"><strong class="text-success">Geller SKU</strong></td>
                                                        <td><strong>{{price_details.geller_sku}}</strong></td> 
                                                        <td width="350"><strong class="text-success">Major Item</strong></td>
                                                        <td><strong>{{price_details.major_item}}</strong></td> 
                                                        <td width="350"><strong class="text-success">Total</strong></td>
                                ...
                                <div class="location_bg">
                                    <div class="jobsListing_info">
                                        <div class="row flex-nowrap align-items-center">
                                            <div>
                                                <div class="jobsListing_col">
                                                    <strong class="d-block text-center">No Data</strong>
                                                </div>
                                            </div>
...
<div class="myModel">
      <div>
        <b-modal id="location-modal" header-border-variant="primary" footer-border-variant="primary" 
        body-bg-variant="primary"   header-bg-variant="primary"   footer-bg-variant="primary" hide-footer
        centered title="Move Envelope to other location">
          <template>
            <div class="JwereList">
                <h6>Move To Locations</h6>
                <div class="">
                    <b-form-group>
                    <b-form-radio-group  :options="rush_options" name="radio-stacked-rush" v-model="selected_location" ></b-form-radio-group>
                    </b-form-group>
                </div>
            </div>
            ...
            <div class="assign_Jweler myForn">    
                ...
                <div class="row "> 
                    <div class="col-lg-12 col-md-12">
                        <div class="assign_Jweler_form mb-4"  v-if="selected_location == 'jeweler_box'">
                            <h6 class="pb-2">Select Jeweler please</h6>
                            <div class="dropdown myDropdown">
                            <b-dropdown id="dropdown-1" text="Choose Jeweler" class="">
                            <b-dropdown-item  @click="selectJeweler(sale_person)" 
                            v-for="sale_person in jewelers" :key="sale_person.id">
                        ...
                        <div class="assign_Jweler_form addNewCustom mb-4" v-if="selected_location=='order_box'">
                         ...
                         <div class="assign_Jweler_form addNewCustom mb-4" v-if="selected_location=='order_box'">
                            <h6 class="pb-2">PLease select whome you want to give order to</h6>
                            <div class="form-group">
                                <div class="dropdown myDropdown">
                                    <b-dropdown id="dropdown-1" text="Choose Vendor" class="">
                                    <b-dropdown-item  @click="selectVendor(sale_person)" 
                                    v-for="(sale_person,index) in vendors" :key="index">
                                    <span>{{sale_person.text}}</span></b-dropdown-item>
                                    </b-dropdown>
                                </div>
                            </div>
                         ...
                         <div class="assign_Jweler_form addNewCustom mb-4" v-if="selected_location=='finished_box'">
            ...
            <div class="sortBttn text-center pt-3">
                <button class="btn btn-success round-border" @click="moveEnvelope()">Move Envelopes</button>
            </div>
...
import Button from '../../components/Global/Button.vue';
    ...
    export default {
      ...
      getJewelers() {
        ...
        axios.get("/api/get-jewelers-of-shop", {
            headers: {
      ...
      getSortBox(page = 1) {
        ...
        var token = localStorage.getItem("token");
        axios
            .get(`/api/get-order-box?filter=${this.searchQuery}&page=` + page, {
            headers: {
                Authorization: "Bearer " + token,
            },
            })
