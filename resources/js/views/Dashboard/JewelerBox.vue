        ...
        <div class="row pb-4 align-items-center">
          <div class="col-lg-4 col-md-4">
            <div class="shank_tittle">
              ...
              <h5 class="m-0 p-0 ml-3">Jeweler Box</h5>
            </div>
          </div>
                  ...
                  <div class="location_bg">
                    <div class="jobsListing_info">
                      ...
                      >
                        ...
                        <div>
                          <div class="jobsListing_col">
                            <strong>Assigned To Jeweler</strong>
                          </div>
                        </div>

                        <div>
                          <div class="jobsListing_col">
                            <strong>Expected Completion Work</strong>
                          </div>
                        </div>
                  ...
                  <div class="location_bg">
                    <div class="jobsListing_info">
                      <div class="row flex-nowrap align-items-center">
                        ...
                        <div>
                          <div class="jobsListing_col">
                            <strong>{{ envelope.placed_order_date }}</strong>
                          </div>
                        </div>
...
export default {
  ...
  methods: {
    ...
    getSortBox(page = 1) {
      ...
      var token = localStorage.getItem("token");
      axios
        .get(`/api/get-jeweler-box?filter=${this.searchQuery}&page=` + page, {
          headers: {
            Authorization: "Bearer " + token,
          },
        })
