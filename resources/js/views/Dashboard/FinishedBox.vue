        ...
        <div class="row pb-4 align-items-center">
          <div class="col-lg-3 col-md-3">
            <div class="shank_tittle">
              ...
              <h5 class="m-0 p-0 ml-3">Finished Box</h5>
            </div>
          </div>
          ...
          <div class="col-lg-5 col-md-5">
            ...
            >
              ...
              <b-button
                ...
                :disabled="ifnoneSelected"
                v-b-modal.location-modal
                >Generate Paid Receipt</b-button
              >
            </div>
          </div>
                  ...
                  <div class="location_bg">
                    <div class="jobsListing_info">
                      ...
                      >
                        ...
                        <div>
                          <div class="jobsListing_col">
                            <strong>Received from Vendor</strong>
                          </div>
                        </div>

                        <div>
                          <div class="jobsListing_col">
                            <strong>Customer acknowledged</strong>
                          </div>
                        </div>

                        <div>
                          <div class="jobsListing_col">
                            <strong>Done with Polish</strong>
                          </div>
                        </div>

                        <div>
                          <div class="jobsListing_col">
                            <strong>Done with Wax</strong>
                          </div>
                        </div>

                        <div>
                          <div class="jobsListing_col">
                            <strong>Done with Appraiser</strong>
                          </div>
                        </div>
                    ...
                    <div class="jobsListing_info">
                      <div class="row flex-nowrap align-items-center">
                        ...
                        <div>
                          <div class="jobsListing_col">
                            {{
                              new Date(envelope.take_in_date).toLocaleString(
                                "en-US",
                                {
                                  year: "numeric",
                                  month: "long",
                        ...
                        <div>
                          <div class="jobsListing_col">
                            {{
                              new Date(envelope.arrival_date).toLocaleString(
                                "en-US",
                                {
                                  year: "numeric",
                                  month: "long",
                        ...
                        <div>
                          <div class="jobsListing_col">
                            {{
                              new Date(envelope.hold_completed).toLocaleString(
                                "en-US",
                                {
                                  year: "numeric",
                                  month: "long",
                        ...
                        <div>
                          <div class="jobsListing_col">
                            {{
                              new Date(envelope.polish_completed).toLocaleString(
                                "en-US",
                                {
                                  year: "numeric",
                                  month: "long",
                        ...
                        <div>
                          <div class="jobsListing_col">
                            {{
                              new Date(envelope.wax_completed).toLocaleString(
                                "en-US",
                                {
                                  year: "numeric",
                                  month: "long",
                        ...
                        <div>
                          <div class="jobsListing_col">
                            {{
                              new Date(envelope.appraiser_completed).toLocaleString(
                                "en-US",
                                {
                                  year: "numeric",
                                  month: "long",
                        ...
                        <div>
                          <div class="jobsListing_col">
                            {{
                              new Date(envelope.completion_date).toLocaleString(
                                "en-US",
                                {
                                  year: "numeric",
                                  month: "long",
...
export default {
  ...
  methods:{ 
      ...
      getSortBox(page = 1) {
        ...
        var token = localStorage.getItem("token");
        axios
            .get(`/api/get-finished-box?filter=${this.searchQuery}&page=` + page, {
            headers: {
                Authorization: "Bearer " + token,
            },
            })
