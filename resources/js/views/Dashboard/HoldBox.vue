        ...
        <div class="row pb-4 align-items-center">
          <div class="col-lg-4 col-md-4">
            <div class="shank_tittle">
              ...
              <h5 class="m-0 p-0 ml-3">Hold Box</h5>
            </div>
          </div>
                    ...
                    <div class="jobsListing_info">
                      <div class="row flex-nowrap align-items-center">
                        ...
                        <div>
                          <div class="jobsListing_col">
                            {{
                              new Date(envelope.hold_from_date).toLocaleString(
                                "en-US",
                                {
                                  year: "numeric",
                                  month: "long",
...
methods:{ 
      ...
      getSortBox(page = 1) {
        ...
        var token = localStorage.getItem("token");
        axios
            .get(`/api/get-hold-box?filter=${this.searchQuery}&page=` + page, {
            headers: {
                Authorization: "Bearer " + token,
            },
            })
