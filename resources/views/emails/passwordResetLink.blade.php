...
<body style="margin:0px; padding:0px 20px; background:#fff;font-family: 'Poppins', sans-serif;">
          ...
          <tbody>
            <tr>
              <td width="600" height="50">
                <h2 style=" margin: auto; text-align: center; padding: 0px 50px 20px;font-size: 24px; color: #000; display: block;  font-weight: bold; max-width: 500px;">Resset Your Password</h2>
              </td>  
            </tr>  
    ...
    <tr> 
      <td width="800" valign="top" ><table width="100%" cellspacing="0" cellpadding="0" border="0">
          <tbody>
            <tr>
              <td width="600" height="50">
                <p style="padding: 0px 20px;"><a href="{{url('/forgot-password?token='.$token)}}" style=" text-align: center; font-weight: 500; border-radius: 50px; background: #3d69e7; display: block; font-size: 18px; padding: 18px 25px; max-width: 260px; margin: auto; color: #fff; text-decoration:none !important;">Resset Password</a></p>
              </td>  
            </tr>  
